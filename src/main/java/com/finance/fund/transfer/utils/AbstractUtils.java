...
abstract class AbstractUtils {
    private static final int AWAIT_PERIOD = 10;
    static final Logger logger = LoggerFactory.getLogger(AbstractUtils.class);
    ...
    AbstractUtils(final Context context, final String message, final int threadPoolSize) {
    ...
    AbstractUtils(final Context context, final String message) {
